...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 3, 0) || (defined(SCSC_SEP_VERSION) && SCSC_SEP_VERSION >= 14))
...
#define SLSI_NL_ATTRIBUTE_COUNTRY_CODE_FALL_BACK 1
#define SLSI_NL_ATTRIBUTE_LATENCY_MODE_FALL_BACK 1
#define SLSI_NL_ATTRIBUTE_TX_POWER_SCENARIO_FALL_BACK 1
#endif
